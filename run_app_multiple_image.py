...
import os
import sys
from pipeline_multiple_images import app_multiple_images
...
if __name__ == "__main__":
    ...
    config = load_config('configs/config_multiple_images.json', override_config_path)

    sys.argv = [sys.argv[0]]
    
    result = app_multiple_images.handler(config, "")
